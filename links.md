...
Recopilación de todos los enlaces interesantes que han ido saliendo en las sesiones, organizados por tema. Entre paréntesis, la sesión donde aparecieron.

---

## Aula y curso

- [Programa formativo IFCT39 (PDF oficial del SEPE)](https://sede.sepe.gob.es/es/portaltrabaja/resources/pdf/especialidades/IFCT39.pdf)
- [Sala Synctube de clase](https://sync-tube.de/room/Up8feWMQ)
...
- [StackEdit](https://stackedit.io/) - editor Markdown online (S02)
- [Markdown cheat-sheet](https://www.markdownguide.org/cheat-sheet/) - chuleta rápida
- [Guía de sintaxis básica](https://www.markdownguide.org/basic-syntax/) (S02)
- [Is Markdown taking over?](https://www.hendrik-erz.de/post/is-markdown-taking-over) - artículo sobre el auge de Markdown (S02)

## HTML y CSS

- [w3schools HTML](https://www.w3schools.com/html/) - tutorial de referencia (S02, S04)
- [w3schools CSS](https://www.w3schools.com/css/) (S04)
- [w3schools Tryit editor](https://www.w3schools.com/tryit/) - editor en vivo para probar código (S02, S03, S04)
- [Validador W3C](https://validator.w3.org/) - validar HTML (S02, S04)
- [Especificaciones del W3C](https://www.w3.org/TR/) - los estándares oficiales
- [Can I use](https://caniuse.com/) - compatibilidad de features entre navegadores
...
- [Proporción áurea](https://ovacen.com/proporcion-aurea-que-es/) (S06)
- [Responsive grid design, guía completa](https://medium.com/@nitishkmrk/responsive-grid-design-ultimate-guide-7aa41ca7892) (S06)
- [RGB y CMYK](https://heyjaime.com/blog/rgb-y-cmyk/) (S06)
- [Hue, saturation y brightness](https://www.colorik.com/the-basics-of-hue-saturation-brightness-in-color-design) (S06)
- [Psicología del color para mejorar conversiones (Adobe)](https://blog.adobe.com/es/publish/2020/06/03/como-usar-la-psicologia-del-color-para-mejorar-las-conversiones) (S06)
- [Rueda de color de Adobe](https://color.adobe.com/es/create/color-wheel) (S06)
...
- [Qué es el SEM: claves del Search Engine Marketing](https://www.youtube.com/watch?v=voxDnfOre-U) (S01)
...
- [Comenzó la caída masiva de vistas en YouTube](https://www.youtube.com/watch?v=YT3jFqggfTA)
- [Por qué YouTube paga menos que antes](https://www.youtube.com/watch?v=lsqZDwrzhAM)
- [Por qué tus visitas en YouTube bajan sin explicación](https://www.youtube.com/watch?v=AbF-Pn4DXSQ)
